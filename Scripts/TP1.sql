...
/* Les verifications */
ALTER TABLE MEDECIN ADD CONSTRAINT CHK_SPECIALITE CHECK(SPECIALITE IN ('Orthopédiste', 'Cardiologue', 'Traumatologue', 'Anesthésiste', 'Pneumologue', 'Radiologue'));
